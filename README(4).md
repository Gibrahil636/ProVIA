...
| Arquivo | Conteúdo |
|---|---|
| `dados/coco_val2017.json` | **95** imagens do COCO val2017 **hospedadas no próprio repositório** (`reais/coco/`), com legenda oficial traduzida para o português. Sem dependência do servidor do dataset. |
...
para o fim do ciclo seguinte. Medição com 1200 exibições (10 sessões × 20 sorteios de 6):
**0 repetições dentro da mesma tela, 0 em relação ao sorteio anterior, 1 reaparição em
até 3 sorteios**, distância média de 25,6 sorteios e uso praticamente uniforme
(entre 6× e 10× por imagem, ideal 7,6×).
